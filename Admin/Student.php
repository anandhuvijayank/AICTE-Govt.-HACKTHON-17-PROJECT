		...
		<div id="left">
	        ...
	        <div id="TabbedPanels1" class="TabbedPanels">
	          <ul class="TabbedPanelsTabGroup">
	            <li class="TabbedPanelsTab style2" tabindex="0">Create Retailer or FPI</li>
	            <!--<li class="TabbedPanelsTab style2" tabindex="0">Manage Retailer</li>-->
              </ul>
	          <div class="TabbedPanelsContentGroup">
	            <div class="TabbedPanelsContent">
                  ...
                  <td><span id="sprytextfield1">
                      ...
                      <tr>
                        <td>Interested Product:</td>
                        <td>
                          <label>
                          <input type="text" name="interestedproduct" id="interestedproduct" required="required"/>
                          </label>
                       </td>
                      </tr>
                      <tr>
