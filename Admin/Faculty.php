		...
		<div id="left">
	        ...
	        <div id="TabbedPanels1" class="TabbedPanels">
              <ul class="TabbedPanelsTabGroup">
                <li class="TabbedPanelsTab style1" tabindex="0"><span class="style1">Create New Farmer</span></li>
               <!-- <li class="TabbedPanelsTab style15" tabindex="0">Display Farmer</li>-->
              </ul>
                          ...
                          <table width="100%" height="186" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td><span id="sprytextfield3">
                                <label>
                                <input type="text" maxlength="10" pattern="[0-9]{10}" title="Enter a valid mobile number" name="txtMobile" id="txtMobile" />
                                </label>
                              <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
                            
                             <tr>
                              <td height="29">AADHAR NO:</td>
                              <td><input name="aadhar" maxlength="12" pattern="[0-9]{12}" title="Enter a valid Aadhar number"  type="text" id="aadhar"/></td>
                            ...
                            <tr>
                              ...
                              <td>
                                <label>
                                <input type="text" name="flocation" id="flocation" required="required" />
                                </label>
                                </td>
                            </tr>
                ...
                <div class="TabbedPanelsContent">
                  <table width="100%" border="1" bordercolor="#85A157" >
                    <tr>
                      ...
                      <th bgcolor="#85A157" class="style3"><div align="left" class="style9 style5"><strong>Farmer Name</strong></div></th>
                      ...
                      <th height="32" bgcolor="#85A157" class="style3"><div align="left" class="style9 style5"><strong>AADHAR ID</strong></div></th>
                    </tr>
                    <?php
...
?>
                    <tr>
                      ...
                      <td bgcolor="#BADFE8" class="style3"><div align="left" class="style9 style6"><strong><?php echo $aadhar;?></strong></div></td>
                    </tr>
                    <?php
}
...
?>
	...
	<div id="footer"><font color="#FFFFFF">HAPPY KISSAN</font></div>	
</div>
