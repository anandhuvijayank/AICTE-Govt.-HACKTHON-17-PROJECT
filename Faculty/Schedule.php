		...
		<div id="left">
	        ...
	        <div id="TabbedPanels1" class="TabbedPanels">
	          <ul class="TabbedPanelsTabGroup">
	            <li class="TabbedPanelsTab style1" tabindex="0">Insert the Product Details</li>
	            <!--</h1><li class="TabbedPanelsTab style2 style3" tabindex="0">Display Product</li>-->
              </ul>
...
?>
                          ...
                          <tr>
                            <td height="32">Select Quantity in kg :</td>
                            <td><label>
	            ...
	            <div class="TabbedPanelsContent">
	              <table width="100%" border="1" bordercolor="#85A157" >
                    <tr>
                      ...
                      <th bgcolor="#85A157" class="style13"><div align="left" class="style9 style5"><strong>Product</strong></div></th>
                      <th bgcolor="#85A157" class="style13"><div align="left" class="style9 style5"><strong>Quantity</strong></div></th>
                      <th height="32" bgcolor="#85A157" class="style13"><div align="left" class="style9 style5"><strong>Price</strong></div></th>
...
$sql = "SELECT quiz_schedule.Schedule_Id, quiz_schedule.Semester,quiz_schedule.price
...
?>
                    <tr>
                      ...
                      <td class="style13"><div align="left" class="style9 style6"><strong><?php echo $price;?></strong></div></td>
                    </tr>
                    <?php
}
