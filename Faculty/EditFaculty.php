	...
	<div id="content">
		<div id="left">
	        ...
	        <table width="100%" height="209" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="33" bgcolor="#E3E5DB"><span class="style10 style11">Edit Farmer Information</span></td>
              </tr>
              <tr>
                <td><?php
$Id=$_GET['FacultyId'];
...
?>
                    <form method="post" action="UpdateFaculty.php?Id=<?php echo $Id;?>">
                      <table width="100%" border="0">
                        <tr>
                          <td height="32"><span class="style8">Farmer Id:</span></td>
                          <td><?php echo $Id;?></td>
                        </tr>
                        <tr>
                          <td height="36"><span class="style8">Farmer Name:</span></td>
